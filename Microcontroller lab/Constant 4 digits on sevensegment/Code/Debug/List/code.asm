...
; 0000 001E void deactivateAllComs(){

	.CSEG
_deactivateAllComs:
; .FSTART _deactivateAllComs
; 0000 001F 
; 0000 0020           PORTD.0=1;
	SBI  0x12,0
; 0000 0021           PORTD.1=1;
...
; 0000 002A 
; 0000 002B int d  = 2;
; 0000 002C int number[4] = {1,3,7,7} ;
; 0000 002D 
...
_0xB:
; 0000 0097       {
; 0000 0098         // activate com of target 7segment
; 0000 0099           PORTD.0=0;
	CBI  0x12,0
; 0000 009A           PORTD.1=1;
	SBI  0x12,1
...
; 0000 009C           PORTD.3 = 1;
	SBI  0x12,3
; 0000 009D           // put the number on portC
; 0000 009E           PORTC = number[0] ;
	LD   R30,Y
	RCALL SUBOPT_0x0
; 0000 009F 
; 0000 00A0           delay_ms(d);
; 0000 00A1 
; 0000 00A2          deactivateAllComs();
; 0000 00A3 
; 0000 00A4           PORTD.0=1;
; 0000 00A5           PORTD.1=0;
	CBI  0x12,1
...
; 0000 00A7           PORTD.3 = 1;
	SBI  0x12,3
; 0000 00A8 
; 0000 00A9           PORTC = number[1];
	LDD  R30,Y+2
	RCALL SUBOPT_0x0
; 0000 00AA 
; 0000 00AB           delay_ms(d);
; 0000 00AC 
; 0000 00AD         deactivateAllComs();
; 0000 00AE 
; 0000 00AF 
; 0000 00B0           PORTD.0=1;
; 0000 00B1           PORTD.1=1;
...
; 0000 00B4 
; 0000 00B5 
; 0000 00B6           PORTC = number[2];
	LDD  R30,Y+4
	RCALL SUBOPT_0x0
; 0000 00B7 
; 0000 00B8           delay_ms(d);
; 0000 00B9 
; 0000 00BA          deactivateAllComs();
; 0000 00BB 
; 0000 00BC           PORTD.0=1;
; 0000 00BD           PORTD.1=1;
	SBI  0x12,1
...
; 0000 00C0 
; 0000 00C1 
; 0000 00C2           PORTC = number[3];
	LDD  R30,Y+6
	OUT  0x15,R30
; 0000 00C3 
; 0000 00C4           delay_ms(d);
	MOVW R26,R16
	CALL _delay_ms
; 0000 00C5 
; 0000 00C6           deactivateAllComs();
	RCALL _deactivateAllComs
; 0000 00C7 
; 0000 00C8 
; 0000 00C9 
; 0000 00CA 
