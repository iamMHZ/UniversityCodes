...
; 0000 0058           PORTC = numbers[3];
	__GETB1MN _numbers,6
	OUT  0x15,R30
; 0000 0059 
; 0000 005A           delay_ms(sevenSegDelay);
	LDS  R30,_sevenSegDelay
	LDS  R31,_sevenSegDelay+1
	LDS  R22,_sevenSegDelay+2
	LDS  R23,_sevenSegDelay+3
	RCALL SUBOPT_0x1
; 0000 005B 
...
SUBOPT_0x2:
	SBI  0x18,5
	SBI  0x18,6
	LDS  R30,_keypadDelay
	LDS  R31,_keypadDelay+1
	LDS  R22,_keypadDelay+2
	LDS  R23,_keypadDelay+3
	RJMP SUBOPT_0x1
