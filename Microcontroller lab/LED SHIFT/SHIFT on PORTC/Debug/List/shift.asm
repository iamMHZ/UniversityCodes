...
; 0000 008D       PORTC.0 = 0;
; 0000 008E       delay_ms(delay);
; 0000 008F 
; 0000 0090 
; 0000 0091       PORTC.0 = 1;
	RCALL SUBOPT_0x0
; 0000 0092       delay_ms(delay)  ;
; 0000 0093       PORTC.0 = 0;
; 0000 0094       delay_ms(delay)       ;
; 0000 0095 
; 0000 0096 
; 0000 0097       PORTC.1 = 1;
	SBI  0x15,1
; 0000 0098       delay_ms(delay)  ;
	RCALL SUBOPT_0x1
; 0000 0099       PORTC.1 = 0;
	CBI  0x15,1
; 0000 009A       delay_ms(delay)      ;
	RCALL SUBOPT_0x1
; 0000 009B 
; 0000 009C 
; 0000 009D 
; 0000 009E       PORTC.2 = 1;
	SBI  0x15,2
; 0000 009F       delay_ms(delay)  ;
	RCALL SUBOPT_0x1
; 0000 00A0       PORTC.2 = 0;
	CBI  0x15,2
; 0000 00A1       delay_ms(delay)     ;
	RCALL SUBOPT_0x1
; 0000 00A2 
; 0000 00A3 
; 0000 00A4 
...
; 0000 00B2       PORTC.5 = 1;
	SBI  0x15,5
; 0000 00B3       delay_ms(delay)  ;
	RCALL SUBOPT_0x1
; 0000 00B4       PORTC.5 = 0;
	CBI  0x15,5
; 0000 00B5       delay_ms(delay)  ;
	RCALL SUBOPT_0x1
; 0000 00B6 
; 0000 00B7 
; 0000 00B8       PORTC.6 = 1;
	SBI  0x15,6
; 0000 00B9       delay_ms(delay)  ;
	RCALL SUBOPT_0x1
; 0000 00BA       PORTC.6 = 0;
	CBI  0x15,6
; 0000 00BB       delay_ms(delay) ;
	RCALL SUBOPT_0x1
; 0000 00BC 
; 0000 00BD 
; 0000 00BE       PORTC.7 = 1;
	SBI  0x15,7
; 0000 00BF       delay_ms(delay)  ;
	RCALL SUBOPT_0x1
; 0000 00C0       PORTC.7 = 0;
	CBI  0x15,7
; 0000 00C1       delay_ms(delay);
	RCALL SUBOPT_0x1
; 0000 00C2 
; 0000 00C3 
; 0000 00C4       }
